...
class ResearchConfig(BaseSettings):
    ...
    n_leaves_contested_threshold: int = Field(default=2, gt=0, description="corroborating >= this with low SA → contested (enough sources checked but none agree), not insufficient data. corroborating < this → corrective_retriever fires to find evidence.")
